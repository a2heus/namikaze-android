...
keyauthapp = api(
    name = "HackingHub", #App name (Manage Applications --> Application name)
    ownerid = "z4lYdEsHPf", #Owner ID (Account-Settings --> OwnerID)
    secret = "7695a298f4d3518fc88980e0a043ead5a12cfaf56180bc8ded7f80d14a666a5e", #App secret(Manage Applications --> App credentials code)
    version = "1.0",
...
time.sleep(2)
os.system("cls")
os.system("title Namikaze BOTNET (by hashkiller#5141)")
os.system("mode 68, 28")
